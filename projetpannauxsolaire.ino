...
if(pos > 140) {pos = 140;} // reset the horizontal postion of the motor to 180 if it tries to move past this point
if(pos < 40) {pos = 40;} // reset the horizontal position of the motor to 0 if it tries to move past this point
